...
const CreateRoomCard = ({ onCreate }: { onCreate: () => void }) => (
  <div
    onClick={onCreate}
    className="bg-white rounded-lg shadow-md border-2 border-dashed border-gray-300 hover:border-blue-400 cursor-pointer transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg"
  >
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Descubre y únete a aventuras épicas</p>
        </div>
