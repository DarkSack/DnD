...
export default function Chat() {
    ...
    return (
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 h-[635px] flex flex-col overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                        {chats.map(chat => (
                            <div
                                ...
                                className={`p-4 cursor-pointer border-b border-gray-100 hover:bg-gray-50 transition-colors ${activeChat?.id === chat.id ? 'bg-purple-50 border-purple-200' : ''
                                    }`}
                            >
                            ...
                            <div className="p-4 border-t border-gray-200 bg-gray-50">
                                <div className="flex items-center gap-3">
                                    ...
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white"
                                    />
                                    <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                                        <Smile size={18} />
                                    </button>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="text-xl font-semibold text-gray-900">Crear Nuevo Grupo</h3>
                            <button
