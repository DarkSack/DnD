...
const SocialList = () => {
    ...
    const handleSendMessage = (user: User) => {
        // Lógica para abrir chat directo
...
// Componente Solicitudes de Amistad
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Solicitudes de Amistad</h2>
